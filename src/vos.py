...
class VOSDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Meta info
        meta = dict(folder_path=folder_path, img_paths=img_paths, lbl_paths=lbl_paths, img_res=(wd, ht))
        ...
        rsz_h, rsz_w = math.floor(img.size(1) / self.mapScale[0]), math.floor(img.size(2) /self.mapScale[1])
